...
| 活跃时段柱状图 | 完成 | 仪表盘 |
| 消息比例饼图 | 完成 | 仪表盘 |
| 情绪时间轴 | 完成 | 情绪时间轴，含关键事件标记 |
| 词云图 x2 | 完成 | 深度分析 |
| 聊天日历热力图 | 完成 | 深度分析 |
| 回复延迟分布图 | 完成 | 深度分析 |
| 消息长度趋势图 | 完成 | 深度分析 |
| 情绪分布对比图 | 完成 | 深度分析 |
| 聊天时段迁移 | 完成 | 深度分析（前后对比柱状图） |
| 情绪互动模式 | 完成 | 深度分析（感染度/修复时间/对抗模式） |
| 关键词追踪 | 完成 | 深度分析（趋势图 + 上下文匹配） |
| 并排对比视图 | 完成 | 深度分析（高频词/字数/延迟/情绪/占比对比） |
...
| 手动里程碑 | 完成 | 时间轴页面添加/删除自定义事件标记 |
| 快捷问题扩展 | 完成 | AI 分析师 11 个预设问题 |
